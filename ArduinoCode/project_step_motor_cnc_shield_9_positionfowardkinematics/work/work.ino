...
void Foward_Kinematics_Calculator(double angle_base, double angle_boom, double angle_arm);//정기구학 계산
...
void loop()
{
  ...
  Foward_Kinematics_Action(45,45,45);
  delay(500);

  Foward_Kinematics_Action(0,0,0);
  delay(500);
}
...
void anglemovementinset(double angle_base, double angle_boom, double angle_arm)
{
  ...
  instantbo = (angle_boom*smallgearstep*microstep*planetarygear*normgear/360);
  instantar = (angle_arm*smallgearstep*microstep*planetarygear*normgear/360);
