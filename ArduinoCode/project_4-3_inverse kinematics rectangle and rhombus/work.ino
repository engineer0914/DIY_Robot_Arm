...
*/
  ...
  for(int i=10;i<=20;i++) Inverse_Kinematics_Action(0,(double)i,10);

  delay(1000*j);

  for(int i=10;i<=20;i++) Inverse_Kinematics_Action(0,20,(double)i);

  delay(1000*j);

  for(int i=20;i>=10;i--) Inverse_Kinematics_Action(0,(double)i,20);

  delay(1000*j);

  for(int i=20;i>=10;i--) Inverse_Kinematics_Action(0,10,(double)i);
