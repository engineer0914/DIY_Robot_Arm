...
#define accelerator   0      //acclereation disable 0 enable 1
...
void loop()
{
  ...
  long instantshower, aa=16*200;

  rotationmovementinsert(0,0,(45*aa)/360);
  instantshower = arm.currentPosition();
  armangle_current = (double)instantshower*360/aa;
  Serial.print("\n angle:");
  Serial.println(armangle_current);
  delay(1000);

  rotationmovementinsert(0,0,(90*aa)/360);
  instantshower = arm.currentPosition();
  armangle_current = (double)instantshower*360/aa;
  Serial.print("\n angle:");
  Serial.println(armangle_current);
  ...
  rotationmovementinsert(0,0,(180*aa)/360);
  instantshower = arm.currentPosition();
  armangle_current = (double)instantshower*360/aa;
  Serial.print("\n angle:");
  Serial.println(armangle_current);
  ...
  rotationmovementinsert(0,0,(270*aa)/360);
  instantshower = arm.currentPosition();
  armangle_current = (double)instantshower*360/aa;
  Serial.print("\n angle:");
  Serial.println(armangle_current);
  ...
  rotationmovementinsert(0,0,(360*aa)/360);
  instantshower = arm.currentPosition();
  armangle_current = (double)instantshower*360/aa;
  Serial.print("\n angle:");
  Serial.println(armangle_current);
