 ...
 * 역기구학 경로 계획
 * 역기구학 풀이
 * 문제점 - 상반신 위치 에서만 역기구학 동작
 * 문제점 - 감속기어 나사 풀림 - 추가 출력 중
 * 이외 다른 해결책 - 벨트풀리 버전으로 개조
 */
...
#define serialcontroller    OFF      //serial cotroller 0 off 1 on
