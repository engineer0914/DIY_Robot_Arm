...
패치노트
  ...
  19. lcd 연결, 버튼 시리얼 활성화 키 무력화, 버튼 입력에 따라 모드 변경, 시연 모드 내장 선택
...
void modeselect()
{
  ...
  lcd.setCursor(9,1);
  lcd.print("3.pnp");//3.시연1번모드 - 픽앤플레이스
  lcd.setCursor(0,1);
  lcd.print("4.invk");//4.시연2번모드 - 역기구학
  for(;;)
  {
