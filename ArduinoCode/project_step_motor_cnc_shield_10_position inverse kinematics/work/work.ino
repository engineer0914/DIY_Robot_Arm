...
double posx = 12.0, posy = 12.0, posz=0.0, y_offset=12;
double boomangle_th1,armangle_th2,th21;
double out_boomangle, out_armangle;
...
void setup()
{
  ...
  //제한 최대 속도
  float speedmotor;
  if(planetarygear==1) speedmotor = 1000.0;
  else if(planetarygear==5) speedmotor = 3000.0;
  else{}
...
void loop()
{
  ...
  for(int i=8;i<23;i++)
  {
    Inverse_Kinematics_Action(0,(double)i,5);
  }
}
