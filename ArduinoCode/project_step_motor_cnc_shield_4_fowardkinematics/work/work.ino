...
void setup()
{
  ...
  boom.setMaxSpeed(1500);
  arm.setMaxSpeed(1500);
...
void anglemovementinset(double angle_base, double angle_boom, double angle_arm)
{
  long instantbo, instantba, instantar;
  instantba = (long)(angle_base*smallgearstep*microstep*planetarygear*normgear/360);
  instantar = (long)(angle_arm*smallgearstep*microstep*planetarygear*normgear/360);
  instantbo = (long)(angle_boom*smallgearstep*microstep*planetarygear*normgear/360);
  rotationmovementinsert(instantba, instantbo, instantar);
}
...
void manualcontroller2()
{
  ...
  if(x >= maxval)
  {
    positions[robot_position_arm] -= adder;
  }
  ...
  if(y <= minval)
  {
    positions[robot_position_boom] += adder;
  }
