...
#define acceleration   0      //acclereation disable 0 enable 1
#define handcontroller 0      //0 joystick 1 button
#define gripper        0      //gripper on 1 off 0
...
int minval = 300, maxval = 700, midval = 500;
long positions[3];
float speedmotor = 1200.0;
...
void setup()
{
  ...
  else if(handcontroller == 1)//button
  {
    pinMode(xbuf,INPUT);
    pinMode(xbub,INPUT);
    pinMode(ybuf,INPUT);
...
*/
  ...
  for(double i=1;i<=5;i++) Inverse_Kinematics_Action(0,15+i,10+i);
  delay(3000);

  for(double i=1;i<=5;i++) Inverse_Kinematics_Action(0,20-i,15+i);
  delay(3000);

  for(double i=1;i<=5;i++) Inverse_Kinematics_Action(0,15-i,20-i);
  delay(3000);

  for(double i=1;i<=5;i++) Inverse_Kinematics_Action(0,10+i,15-i);
  delay(3000);
...
void modeselect()
{
  ...
  else if(handcontroller == 1)//button control
  {
