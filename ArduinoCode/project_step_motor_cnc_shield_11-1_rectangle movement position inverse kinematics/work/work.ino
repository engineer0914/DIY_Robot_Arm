...
*/
  ...
  for(int i=10;i<=20;i++)
  {
    Inverse_Kinematics_Action(0,(double)i,10);
  }
  delay(3000);

  for(int i=10;i<=23;i++)
  {
    Inverse_Kinematics_Action(0,20,(double)i);
  }
  delay(3000);

  for(int i=20;i>=10;i--)
  {
    Inverse_Kinematics_Action(0,(double)i,23);
  }
  delay(3000);

  for(int i=23;i>=10;i--)
  {
    Inverse_Kinematics_Action(0,10,(double)i);
  }
  delay(3000);
